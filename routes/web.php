...
Route::get('/admin/about/add', [AboutController::class, 'add'])->name('admin.add');
Route::post('/admin/about/create', [AboutController::class, 'store'])->name('admin.create');
Route::put('/admin/about/update/{id}', [AboutController::class, 'update'])->name('admin.update');